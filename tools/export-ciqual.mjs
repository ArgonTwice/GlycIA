...
/* ==========================================================================
   ...
   --------------------------------------------------------------------------
   db.json reste le noyau : aliments choisis, portions realistes, IG sourcé.
   ...
   - l'IG n'est pas dans Ciqual, il est estime par guessIG() cote app ;
...
const fichier = {
  ...
  _reserves: [
    "L'index glycemique n'est pas publie par Ciqual : l'app l'estime, la fiche le dit.",
