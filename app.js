...
function gpReason(f) {
  ...
  const repere = f._gpsrc ? `Repère de la table gastroparésie : « ${f._gpsrc} ».` : null;
  ...
  if (lv === 3) {
    ...
    out.length = 0;
    out.push(green ? green[1] : repere || 'Texture tendre et peu de gras : l’estomac n’a presque rien à broyer.');
  } else {
